...
export default function BotonBaja() {
  ...
  return (
    <div className="pt-8 mt-8 border-t-2 border-zinc-950 dark:border-zinc-800">
      <h3 className="text-lg font-extrabold text-alert uppercase tracking-wide mb-2">Zona de Peligro</h3>
      ...
      <button
        onClick={handleBaja}
        disabled={isPending}
        className="w-full md:w-auto px-6 py-3 rounded-xl border-2 border-zinc-950 bg-alert text-white font-bold text-base shadow-[4px_4px_0px_0px_#09090b] transition-transform duration-200 hover:-translate-y-0.5 focus:outline-none focus:ring-4 focus:ring-alert/30 disabled:opacity-60 disabled:cursor-not-allowed"
      >
