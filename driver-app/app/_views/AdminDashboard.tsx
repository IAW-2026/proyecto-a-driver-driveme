      ...
      <div className="rounded-card border border-[rgba(220,38,38,0.15)] bg-[rgba(20,20,20,0.8)] backdrop-blur-sm shadow-[0_0_20px_rgba(220,38,38,0.04)] p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-3 rounded-card border border-[rgba(255,255,255,0.06)] bg-[#0A0A0A]">
            <p className="text-xs font-bold text-[#6B7280] uppercase tracking-wider mb-1">Tasa de finalización</p>
          ...
          <div className="p-3 rounded-card border border-[rgba(255,255,255,0.06)] bg-[#0A0A0A]">
            <p className="text-xs font-bold text-[#6B7280] uppercase tracking-wider mb-1">Conductores online</p>
            <p className="text-2xl font-extrabold text-white">
              {totalConductores > 0
          ...
          <div className="p-3 rounded-card border border-[rgba(255,255,255,0.06)] bg-[#0A0A0A]">
            <p className="text-xs font-bold text-[#6B7280] uppercase tracking-wider mb-1">Recaudación promedio/viaje</p>
            <p className="text-2xl font-extrabold text-white">
              {viajesFinalizados > 0
